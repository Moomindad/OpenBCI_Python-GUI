...
class OpenBCIBoard(object):
    """
    Handles a connection to an OpenBCI board.
    ...
    # The sample rate for equipment is half of the normal, twice as many channels to sample.
    #
    ...
    def start_streaming(self, callback, lapse=-1):
        ...
        Args:
          ...
          lapse: TODO: Needs to be defined.
        ...
        while self.streaming:
            ...
            if self.daisy:
                ...
                #
                # Even sample: concatenate and send if last sample was the fist part, otherwise drop
                # the packet
                #
    ...
    def print_incoming_text(self):
        ...
        if self.ser.inWaiting():
            ...
            while '$$$' not in line:
                #
                # We are supposed to get UTF8 text, but the board might behave otherwise. Better safe than sorry.
                #
